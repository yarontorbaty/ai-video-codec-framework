"""
V3.0 LLM Client - Direct HTTP API (Python 3.7 compatible)

Generates video compression code using Anthropic's Claude API via direct HTTP calls
"""
...
class ClaudeClient:
    """Interface to Claude API via direct HTTP (no SDK required)"""
